...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("37.60.232.250".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Priv8Remote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["37.60.232.250"];
pub const RS_PUB_KEY: &str = "utozMIqeaHiVFi95fscQe+CDzTv6JjbuXExWD3O0d7A=";
